...
const testimonialData: Testimonial[] = [
  ...
  },
  {
    ...
    designation: "Teaching Maths for 20+ years",
    content:
  ...
  },
  {
    ...
    content:
      "With a passion for unlocking the potential in young minds, Lethium Frenci is a seasoned IIT JEE mentor known for his personalized approach to coaching. Armed with years of teaching experience and a knack for simplifying complex concepts, he has guided numerous students to success in one of the toughest exams in the world.",
